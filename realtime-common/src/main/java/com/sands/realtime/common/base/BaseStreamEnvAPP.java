...
@Getter
@Slf4j
public abstract class BaseStreamEnvAPP implements IBaseAPP {
     ...
     */
    public abstract void handle(StreamExecutionEnvironment streamEnv, ParameterTool parameters);
